...
import { ShieldAlert, Search, Filter, X, CheckCircle, XCircle, ArrowUp, ArrowDown, Clock, Eye, ChevronDown, ChevronRight } from '@/lib/animated-icons';
...
export default function VerifikasiLogPage() {
  ...
  if (error) return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      <ShieldAlert className="w-16 h-16 text-destructive/60 mb-4" />
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          { label: 'Total Verifikasi', value: stats.total, icon: ShieldAlert, color: 'bg-blue-500', shadow: 'shadow-blue-500/20' },
