...
const events = [
  { year: '2010', title: 'Berdirinya KUD', desc: 'KUD Desa Sari Subur resmi didirikan pada 12 Juli 2010 oleh 50 pekebun sawit binaan CV. Sumatera Multi Jaya di Kecamatan Megang Sakti.', icon: 'M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z', color: 'bg-blue-500' },
  { year: '2015', title: 'Ekspansi Layanan', desc: 'KUD melebarkan sayap melayani lebih dari 300 pekebun di 3 desa: Sari Subur, Megang Sakti, dan Tugu Sari. Program PSR mulai diperkenalkan.', icon: 'M2.25 21h19.5m-18-18v18m10.5-18v18m6-18v18M3 7h2.25m-2.25 3h2.25m-2.25 3h2.25', color: 'bg-emerald-500' },
