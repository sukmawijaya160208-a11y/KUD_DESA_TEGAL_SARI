      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        <motion.div initial={{ x: -30, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.5 }}
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h3 className="font-heading font-bold text-foreground">KUD Desa Tegal Sari</h3>
          ...
          <div className="space-y-3 text-sm">
            {[
              ...
              { icon: 'M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75', label: 'Email', value: 'info@kudtegalari.id' },
        ...
        <motion.div initial={{ x: 30, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }}
          ...
          <iframe
            ...
            title="Lokasi KUD Desa Tegal Sari" />
        </motion.div>
      </div>
    </section>
  );
