...
export default function KartuAdmin({ data, width = 360, showActions = true, onClose }) {
  ...
  <div style="display:flex;flex-direction:column;align-items:center;gap:12px;font-family:Inter,'Segoe UI',Roboto,system-ui,sans-serif;">
    ...
    return `
  <div style="display:flex;flex-direction:column;align-items:center;gap:12px;font-family:Inter,'Segoe UI',Roboto,system-ui,sans-serif;">
    <div style="width:480px;border-radius:6px;box-shadow:0 4px 24px rgba(0,0,0,0.12);">
      ...
      <div style="background:#ffffff;padding:12px;display:flex;flex-direction:column;min-height:170px;">
        ...
        <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-top:4px;">
          ...
          <div style="text-align:right;font-size:${bc('kota_tanggal', 'fontSize') || 7}px;color:${bc('kota_tanggal', 'color') || '#64748b'};">
            ...
            ${b('ttd_stempel').show !== false ? `<div style="display:flex;align-items:center;justify-content:flex-end;gap:2px;min-height:48px;">${stempelHtml}<img src="/images/qr-ttd-ketua.jpg" alt="Verifikasi" style="width:36px;height:36px;border-radius:2px;border:1px solid #e2e8f0;" /></div>` : ''}
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .front-right { width: ${100 - leftPanelPct}%; background: white; padding: 2mm 2.5mm; display: flex; flex-direction: column; position: relative; }
    ...
    <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-border">
      <div className="p-4 sm:p-6">
        ...
        <div className="text-center mt-3">
          <p className="text-[10px] text-gray-400">Ukuran: 88mm × 56mm &bull; Cetak: sisi depan &bull; sisi belakang (2 halaman)</p>
        </div>
      </div>
    </div>
  );
